...
namespace GoogleFu
{
	...
	public class Hoja1Row 
	{
		...
		public Hoja1Row(string __NAMEENEMY0, string __NAMEENEMY1, string __NAMEENEMY2, string __NAMEENEMY3, string __NAMEENEMY4, string __NAMEENEMY5, string __NAMEENEMY6, string __NAMEENEMY7, string __NAMEENEMY8, string __NAMEENEMY9) 
		{
	...
	public class Hoja1 :  GoogleFuComponentBase
	{
		public enum rowIds {
			WAVE_1, WAVE_2
		};
		...
		public System.Collections.Generic.List<Hoja1Row> Rows = new System.Collections.Generic.List<Hoja1Row>();
		public override void AddRowGeneric (System.Collections.Generic.List<string> input)
		{
			Rows.Add(new Hoja1Row(input[0],input[1],input[2],input[3],input[4],input[5],input[6],input[7],input[8],input[9]));
		}
		public override void Clear ()
		{
			Rows.Clear();
		}
		public Hoja1Row GetRow(rowIds rowID)
		{
			Hoja1Row ret = null;
			try
			{
		...
		public Hoja1Row GetRow(string rowString)
		{
			Hoja1Row ret = null;
			try
			{
